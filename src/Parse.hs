...
--- >>> parseFromString exprP "2+(3*4-3)/2"
--- Right (Op Plus (Val (IntVal 2)) (Op Divide (Op Times (Val (IntVal 3)) (Op Minus (Val (IntVal 4)) (Val (IntVal 3)))) (Val (IntVal 2))))
---
